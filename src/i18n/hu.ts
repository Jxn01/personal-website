...
export const hu: Dict = {
  ...
  about: {
    ...
    paras: [
      ...
      "Ami tényleg hajt: hogy a dolgok <em>működjenek</em>, aztán hogy <em>jók</em> legyenek. Én vagyok az, aki megjavítja az éles rendszert, aztán este azt a frontend animációt csiszolgatja, amit senki nem kért. Mindkét oldal számít: az egyik életben tartja a rendszert, a másik miatt öröm bekapcsolni.",
  ...
  experience: {
    ...
    intro:
      "Az EverLink beléptető- és parkolórendszereket épít — fizikai infrastruktúrát, szoftveraggyal. Kártyaolvasók, sorompók, kioszkok, és a platform, ami az egészet vezényli. Kis cég, védőháló nélkül — nincs „majd valaki más”. Ami a tiéd, az a <em>tiéd</em>.",
    domainsLead: "Az én területem a kliensoldal és minden, ami hozzá kapcsolódik:",
    domains: [
      {
        label: "Frontend",
        body: "a React + TypeScript alkalmazás, amit az operátorok ténylegesen használnak — én húztam fel, és én tartom szigorúan (a <code>tsconfig</code> ipari szigorúságra állítva, mert az <code>any</code> nem típus, hanem beismerő vallomás).",
      },
      {
        label: "Backend",
    ...
    fieldNotes: [
      ...
      },
      {
        ...
        body: "A kódbázist a „PHPStan level 2, kétszáz-plusz hiba” állapotból felvittem level 8-ra, tisztán. Nem látványos. Minden szint száz apró vita a múltbeli önmagaddal. A kódbázis azóta kevesebbet vitatkozik vissza.",
      },
      {
        id: "FN-04",
  ...
  ai: {
    ...
    paras: [
      ...
      "Amiben <em>nem</em> hiszek: beírni a promptba, hogy „ne hibázz”, és bugmentes kódot várni tőle. A modell az ítélőképesség erősítője. Szorozd meg a nulla ítélőképességet bármivel: nagyon gyors nullát kapsz.",
      "A toolchain a kíváncsiaknak: Claude Code és Cursor napi szinten, több modellszolgáltató, feladattól függően váltva. Otthon saját vason futtatok lokális modelleket — Open WebUI chat-workflow-khoz, ComfyUI kép- és videógeneráláshoz —, mert egy eszköz korlátait úgy lehet a legjobban megérteni, ha magad hosztolod.",
    ],
  },
  stack: {
    title: "STACK",
  ...
  offclock: {
    ...
    items: [
      ...
      {
        label: "D&D",
        body: "Jelenleg egy kaotikus-semleges gnóm artificert játszom, akinek Gloria nevű ágyúja van. Több évnyi DM-elés után játékosnak lenni olyan, mint a nyaralás, csak robbanásokkal.",
      },
      {
        label: "Okosotthon",
